const contactItems = [
  ...
  },
  {
    ...
    label: "Phone",
    content: (
      <a href="tel:+995555000000" className="text-sm text-slate-700 hover:text-secondary transition-colors">
        +995 555 000 000
      </a>
    ),
  },
  ...
  },
  {
    ...
    label: "Working Hours",
    content: <p className="text-sm text-slate-700">Mon – Fri: 9:00 – 18:00</p>,
  },
];
...
export default function ContactInfo() {
  return (
    <div>
      <h2 className="text-lg font-bold text-slate-900 mb-8">Get in Touch</h2>
