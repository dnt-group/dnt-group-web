          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden relative md:flex items-center bg-slate-100 rounded-full p-0.5">
              ...
              <div
                ...
                style={{
                  transform: activeLang === "EN" ? "translateX(2px)" : "translateX(calc(100% + 2px))",
                }}
              />
              {languages.map((lang) => (
                <button
                  ...
                  className={`relative z-10 w-9 py-1 text-xs font-bold tracking-wider rounded-full cursor-pointer transition-colors duration-200 ${
                    activeLang === lang ? "text-white" : "text-slate-400 hover:text-slate-600"
                  }`}
                >
                  {lang}
                </button>
            ...
            >
              <span className={`block h-0.5 w-6 bg-gray-900 transition-all duration-300 ${menuOpen ? "translate-y-2 rotate-45" : ""}`} />
              <span className={`block h-0.5 w-6 bg-gray-900 transition-all duration-300 ${menuOpen ? "opacity-0" : ""}`} />
              <span className={`block h-0.5 w-6 bg-gray-900 transition-all duration-300 ${menuOpen ? "-translate-y-2 -rotate-45" : ""}`} />
            </button>
          </div>
